    ...
    (e.stemmer = (function () {
      var e = {
        ...
        I = function (r) {
          ...
          return (
            (a = h), (o = T).test(r) && a.test(r) && ((o = g), (r = r.replace(o, ''))), 'y' == s && (r = s.toLowerCase() + r.substr(1)), r
          );
        };
      return function (e) {
        return e.update(I);
        ...
        return (
          ...
          (Search.prototype.setCurrentResult = function (dir) {
            ...
            if (current) {
              ...
              (current = this.results.querySelector(1 == dir ? 'li:first-child' : 'li:last-child')) && current.classList.add('current');
          }),
