...
/**
 * Returns an Observable boolean that is the logical NAND of the source and the input boolean.
 *
 * @category Combinator
 *
 ...
 */
export function nand(other: Subscribable<boolean> | boolean): OperatorFunction<boolean, boolean> {
